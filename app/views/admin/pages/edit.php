...
<?php require BASE_VIEW . 'admin/navigation.php' ?>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<hr>
				<ol class="breadcrumb">
					<li><a href="<?php echo $app->generate('admin-page-index') ?>">#PAGE</a></li>
	...
	<div class="container">
		<div class="row">
			<form method="POST" action="<?php echo $app->generate('admin-page-update', ['id' => $blogPageCategoryById->id]); ?>" enctype="multipart/form-data">
				<div class="col-sm-12 col-md-12 col-lg-8">
					...
					<div class="form-group">
						<label>TITLE</label>
						<input type="text" name="title" class="form-control" value="<?php echo $blogPageCategoryById->title; ?>">
					</div>
					<div class="form-group">
						<label>CATEGORY</label>
						<select name="categories" class="form-control">
							<option value="<?php echo $blogPageCategoryById->category_id ?>">
							<?php echo $blogPageCategoryById->name ?>
							</option>
					...
					<div class="form-group">
						<textarea name="body" id="mytextarea" class="form-control" rows="10">
							<?php echo $blogPageCategoryById->body; ?>
						</textarea>
					</div>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="form-group">
								<label>DATE</label>
								<input type="date" name="created_at" class="form-control" value="<?php echo $blogPageCategoryById->created_at; ?>">
							</div>
							<hr>
							<div class="checkbox">
								<label>
									<?php if($blogPageCategoryById->headline){ ?>
							...
							<?php if(count($blogPageCategoryById->image) != null): ?>
							<div class="form-group">
