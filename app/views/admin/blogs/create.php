...
<?php require BASE_VIEW . 'admin/navigation.php' ?>
	...
	<div class="container">
		<div class="row">
			<form method="POST" action="<?php echo $app->generate('admin-blog-store') ?>" enctype="multipart/form-data">
				<div class="col-sm-12 col-md-12 col-lg-8">
					...
					<div class="form-group">
						<textarea name="body" id="mytextarea" class="form-control" rows="10"></textarea>
					</div>
				</div>
